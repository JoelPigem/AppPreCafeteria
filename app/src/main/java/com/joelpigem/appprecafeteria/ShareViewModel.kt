...
class ShareViewModel : ViewModel() {
   ...
   /* private val _primerPlat = MutableLiveData<MenuModel>()
    ...
    fun calcularPreuTotal() {
        _preuTotalPrimerPlat = primerPlat.preuUnitari * primerPlat.quantitat
        _preuTotalBeguda = beguda.preuUnitari * beguda.quantitat

        _preuTotal = preuTotalPrimerPlat + _preuTotalBeguda
    }
}